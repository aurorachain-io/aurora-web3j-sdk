 ...
 */
public class AOASyncing extends Response<AOASyncing.Result> {

    @Override
    @JsonDeserialize(using = AOASyncing.ResponseDeserialiser.class)
    public void setResult(AOASyncing.Result result) {
