 ...
 * This is so that we can pass around Typed {@link com.aoa.web3j.abi.datatypes.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends com.aoa.web3j.abi.datatypes.Type>
    ...
    public static <T extends  com.aoa.web3j.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends  com.aoa.web3j.abi.datatypes.Type>
