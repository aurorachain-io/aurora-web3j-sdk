package com.aoa.web3j.utils;


import com.aoa.web3j.utils.exceptions.MessageDecodingException;
import com.aoa.web3j.utils.exceptions.MessageEncodingException;
...
public final class Numeric {
    ...
    private static final String AOA_PREFIX = "AOA";
    ...
    public static String cleanHexOrAoaPrefix(String input) {
        if (containsAOAPrefix(input) && input.length() >= 43) {
    ...
    public static String prependAOAPrefix(String input) {
        if (!containsAOAPrefix(input)) {
            return AOA_PREFIX + input;
        } else {
            return input;
        }
    }
    ...
    public static boolean containsAOAPrefix(String input) {
        return input.length() > 2 && (input.charAt(0) == 'A' || input.charAt(0) == 'a') &&
               (input.charAt(1) == 'O' || input.charAt(1) == 'o') && (input.charAt(2) == 'A' || input.charAt(2) == 'a');
    }
